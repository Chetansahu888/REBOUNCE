...
I have voluntarily elected to use and, if applicable, to allow minor child / children identified in this form, and all minor children under my supervision and referred to individually and collectively herein as “Child”, to use the LEVLZ RAIPUR LLP facilities and equipment located at following centers (the “LEVLZ RAIPUR LLP”):
1.) LEVLZ, Plot 338/31 Labhandi signal, opp. Indira Gandhi Agricultural University, Raipur, Chhattisgarh 492012

In consideration for being allowed to use LEVLZ RAIPUR LLP Facility, and any other services provided by LEVLZ RAIPUR LLP or its employees or agents at the aforesaid locations, or any other location, I represent, acknowledge and agree as follow:

<strong>General Release</strong>
From the date of signing and for all future visits of myself and my Child, I acknowledge and agree that this Agreement covers and is intended to release and provide other benefits, legal protections, and consideration to the LEVLZ RAIPUR LLP, and their respective and collective agents, owners, officers, managers, shareholders, affiliates, volunteers, participants, employees, and all other persons or entities acting in any capacity on their respective or collective behalf.

<strong>Release of Potential Injuries</strong>
I acknowledge and agree that the use of trampolines and the other equipment at the LEVLZ RAIPUR LLP Facility and that participating in trampoline and other activities is inherently and obviously dangerous. These risks include serious physical or emotional injury, paralysis, death, damage to myself, the Child, and/or third parties, and damage to personal property of any or all such persons.
...
I acknowledge and agree that, while the trampoline and other activities that take place at the LEVLZ RAIPUR LLP Facility are monitored generally by LEVLZ RAIPUR LLP Facility employees, it is not feasible for such employees to monitor the activities and actions of all customers at all times or all customers simultaneously.
Further, I understand that there may arise situations or circumstances when employees of LEVLZ RAIPUR LLP may have difficult jobs to perform, and may seek safety, but they are not infallible. They might be unaware of a participant’s health or abilities, or may give incomplete warnings or instructions, and the equipment being used might malfunction.

<strong>Voluntary Assumption of Risk</strong>
I acknowledge and agree that I and the Child are participating voluntarily at our own risk. I acknowledge and agree that the actions or activities of other customers or the actions or inactions of LEVLZ RAIPUR LLP Facility employees could cause me or the Child significant bodily injury (as described in this Agreement), and that LEVLZ RAIPUR LLP Facility is not responsible for the actions or activities of customers using the LEVLZ RAIPUR LLP Facility or the negligence of its employees in supervising the LEVLZ RAIPUR LLP Facility or its usage, including actions, activities, or omissions that result in such harm. Some of the risks include, but are not limited to, the following:
Participants may die or become paralyzed, partially or fully, through their use of the LEVLZ RAIPUR LLP Facility and participation in LEVLZ RAIPUR LLP Facility.
Participants may suffer physical injury, including but not limited to, cuts, scrapes, bumps, bruises, the transmission of disease strains and allergic reactions through use of the LEVLZ RAIPUR LLP Facility equipment or contact with other participants or surfaces they have contacted. Participants may sprain, pull, break or otherwise seriously externally or internally injure their head, face (including nose and teeth/jaw), neck, torso, spine, arms, wrists, hands, legs, ankles, feet or other body parts as a result of falling off the trampoline(s) or other equipment, landing improperly on the trampolines or other equipment, or making contact with other participants. As noted in paragraph (a) above, such injuries can lead to paralysis, disfigurement or death. Participation may result in heat stroke, heart attacks, dehydration and other exertion-related medical events.
...
I acknowledge, accept, and assume the risk of any and all medical conditions, limitations, or disabilities (whether temporary or permanent) that I or the Child possess, whether known or unknown, which might contribute to or exacerbate any injury I or the Child might sustain as a result of using the LEVLZ RAIPUR LLP Facility or any of its equipment. I acknowledge and agree that if medical assistance (of any form, including emergency care, hospitalization, out-patient care, and/or physical therapy) is required or performed as a result of any injury I or the Child sustains while using the LEVLZ RAIPUR LLP Facility, such assistance shall be at my own expense.

<strong>Release of Liability</strong>
I, the Child and/or any person claiming under or on behalf of me and/or the Child (hereinafter referred to as the “Releasing Parties”) forever, irrevocably and unconditionally release, waive, relinquish, discharge from liability and covenant not to sue LEVLZ RAIPUR LLP, and their successors, predecessors-in-interest, and insurers from any and all claims, demands, rights, actions, suits, causes of action, obligations, debts, costs, losses, charges, expenses, attorneys' fees, damages, judgments and liabilities, of whatever kind or nature, in law, equity or otherwise, whether now known or unknown, suspected or unsuspected, and whether or not concealed or hidden, related to or arising, directly or indirectly, from my or the Child's access to and/or use of the LEVLZ RAIPUR LLP Facility, premises and/or its equipment (whether trampolines or otherwise), the Child's and/or my entry into the LEVLZ RAIPUR LLP Facility, the condition, maintenance, inspection, supervision, control or security of the LEVLZ RAIPUR LLP Facility, the failure to warn of dangerous conditions in connection with the LEVLZ RAIPUR LLP Facility, and/or the acts or omissions of LEVLZ RAIPUR LLP, including, without limitation, any claim for negligence, failure to warn or other omission, property damage, personal injury, emotional injury, illness, bodily harm, paralysis or death.
I understand that this release and waiver applies not only to use of the trampolines, but also all other equipment, and all activities and games at the LEVLZ RAIPUR LLP Facility.
I understand that this release and waiver applies to and includes all activities that I or the Child engage in at the premises, whether inside or outside the LEVLZ RAIPUR LLP Facility.
In the event that any claim released herein is brought by, or asserted on behalf of, the Releasing Parties, I shall immediately defend, indemnify and hold harmless the LEVLZ RAIPUR LLP Facility and/or its employees, and any of them, from any loss or liability, including reasonable attorneys' fees, associated therewith or arising therefrom.

<strong>Arbitration of Disputes and Time Limit to Bring Claim</strong>
I understand that by agreeing to arbitrate any dispute as set forth in this section, I am waiving my right, and the right(s) of the Child, to maintain a lawsuit against LEVLZ RAIPUR LLP for any and all claims covered by this Agreement.
By agreeing to arbitrate, I understand that I will not have the right to have my claim determined by a jury, and the Child will not have the right to have claim(s) determined by a jury. Reciprocally, LEVLZ RAIPUR LLP and the other releasees waive their right to maintain a lawsuit against me and the Child for any and all claims covered by this Agreement, and they will not have the right to have their claim(s) determined by a jury.
Any dispute, claim or controversy arising out of or relating to my or the Child's access to and/or use of the LEVLZ RAIPUR LLP Facility and/or LEVLZ RAIPUR LLP’s premises and/or its equipment, including the determination of the scope or applicability of this agreement to arbitrate, shall be brought within one year of its accrual (i.e., the date of the alleged injury) and be determined by arbitration in the state of Karnataka before one arbitrator. The arbitration shall be administered by the Arbitration and Conciliation Act, 1996. The judgment on the award may be entered in any court having jurisdiction. This clause shall not preclude parties from seeking provisional remedies in aid of arbitration from a court of appropriate jurisdiction.
...
In connection with my and the Child's use of the LEVLZ RAIPUR LLP Facility, I consent to the recording of the Child's and my physical likeness and/or voice through mechanical, photographic, technical, digital, electronic or other means (hereinafter referred to as "Recordings").
I hereby consent to and authorize LEVLZ RAIPUR LLP and its agents, representatives, employees, successors and assigns to use, in perpetuity, such Recordings, as well as the Child's name and my name, for any purpose, including advertising, promoting, exploiting and/or publicizing any LEVLZ RAIPUR LLP Facility.
...
I understand that this agreement extends forever into the future and will have full force and legal effect each and every time I or the Child visit LEVLZ RAIPUR LLP Facility, whether at the current location or any other location or facility.

<strong>Safety is my Responsibility</strong>
I and the Child agree to follow the code of patron responsibility:
I acknowledge that there are inherent risks in the participation in the activities or equipment at LEVLZ RAIPUR LLP Facility, and that such risks include not only the use of trampolines, but other activities and equipment. Patrons of an activity court who use the equipment, and those who engage in any other activities or use any other equipment, by participation, accept the risks inherent in such participation of which the ordinary prudent person is or should be aware. Patrons have a duty to exercise good judgment and act in a responsible manner while using the equipment, and while engaging in such activities. Patrons have a duty to obey all oral or written warnings, or both, prior to or during participation, or both.
...
I have a duty to properly use all safety equipment provided at LEVLZ RAIPUR LLP Facility.
...
I have a duty to conform with or meet height, weight or age restrictions imposed by the manufacturer or owner to use or participate in any activity or use of equipment at LEVLZ RAIPUR LLP Facility.
I have a duty to avoid crowding or overloading individual sections of the LEVLZ RAIPUR LLP Facility.
I have a duty to use the equipment at LEVLZ RAIPUR LLP Facility, within own limitations, training and acquired skills.
I have a duty to avoid landing on the head or neck. Serious injuries, paralysis or death can occur when landing on the equipment at LEVLZ RAIPUR LLP Facility.
...
I would like to receive email promotions, discounts, and other advertisements from LEVLZ RAIPUR LLP and its partners at the email address provided below. I may unsubscribe at any time.
I have had sufficient opportunity to read this document. I have read and understood and agree to be bound by its terms.
I understand that employees working at the LEVLZ RAIPUR LLP Facility, including the manager, do not have the authority to waive any provision of this Agreement. This Agreement constitutes and contains the entire agreement between LEVLZ RAIPUR LLP and me relating to the Child's and my use of the LEVLZ RAIPUR LLP Facility. There are no other agreements, oral, written, or implied, with respect to such matters.
  ...
  return (
    <div className="h-full w-full flex items-center justify-center p-4 relative overflow-hidden safe-area-padding">
      ...
      <div className="w-full max-w-md md:max-w-2xl relative z-10 animate-bounce-in px-4 md:px-0 flex flex-col justify-center max-h-full py-4">
        <div className={`glass-card w-full box-border rounded-[2rem] md:rounded-[2.5rem] flex flex-col relative max-h-[85vh] max-h-[85dvh] scrollbar-hide ${step === 3 ? 'overflow-hidden h-[80vh] h-[80dvh]' : 'overflow-y-auto p-6 md:p-8'}`}>
